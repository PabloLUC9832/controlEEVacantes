<div class="col-span-6">
    ...
    <select  id="idZona-dropdown" name="idZona" class="estiloSelect">
        <option value="{{$dependencia->id_zona}}">{{$dependencia->id_zona}}</option>
...
<div class="col-span-6">
    ...
    <select id="nombreZona-dropdown" class="estiloSelect" name="nombreZona">
        <option value="{{$dependencia->nombre_zona}}">{{$dependencia->nombre_zona}}</option>
    </select>
</div>
